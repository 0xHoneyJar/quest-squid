...
export const functions = {
  ...
  addNewExtraAsset: fun("0xfcb99905", "addNewExtraAsset(address,uint64)", {
    token: p.address,
    _unlockRatePerSecond: p.uint64,
  }),
  allowance: viewFun(
    "0xdd62ed3e",
  ...
  convertToAssets: viewFun(
    "0x07a2d13a",
    "convertToAssets(uint256)",
    { shares: p.uint256 },
    p.uint256
  ),
  convertToShares: viewFun(
    "0xc6e6f592",
  ...
  enableCollateral: fun("0xee59d540", "enableCollateral(address,uint64)", {
    _collateral: p.address,
    _unlockRatePerSecond: p.uint64,
  }),
  extSloads: viewFun(
    "0x7784c685",
  ...
  offset: fun("0xe6666733", "offset(address,uint256,uint256)", {
    collateral: p.address,
    _debtToOffset: p.uint256,
    _collToAdd: p.uint256,
  }),
  owner: viewFun("0x8da5cb5b", "owner()", {}, p.address),
  pendingOwner: viewFun("0xe30c3978", "pendingOwner()", {}, p.address),
  previewDeposit: viewFun(
    "0xef8b30f7",
  ...
  previewRedeem: viewFun(
    "0x4cdad506",
    "previewRedeem(uint256)",
    { shares: p.uint256 },
    p.uint256
  ),
  previewWithdraw: viewFun(
    "0x0a28a477",
  ...
  receiveDonations: fun("0x62edd2f5", "receiveDonations(address)", {
    receiver: p.address,
  }),
  ...
  removeExtraAsset: fun("0x6cd611be", "removeExtraAsset(address)", {
    token: p.address,
  }),
  renounceOwnership: fun("0x715018a6", "renounceOwnership()", {}),
  setPairThreshold: fun(
    "0xbadd8b2d",
    "setPairThreshold(address,address,uint256)",
    { tokenIn: p.address, tokenOut: p.address, thresholdInBP: p.uint256 }
  ),
  setRebalancer: fun("0xfe5198a4", "setRebalancer(address,bool)", {
    rebalancer: p.address,
    isRebalancer: p.bool,
  }),
  setUnlockRatePerSecond: fun(
    "0x0b983a74",
    "setUnlockRatePerSecond(address,uint64)",
    { token: p.address, _unlockRatePerSecond: p.uint64 }
  ),
  startCollateralSunset: fun("0x19f27b3b", "startCollateralSunset(address)", {
    collateral: p.address,
  }),
  ...
  unclaimedUnvestedAmount: viewFun(
    "0x1c3d033f",
    "unclaimedUnvestedAmount(address)",
    { token: p.address },
    p.uint256
  ),
  vestedAmount: viewFun(
    "0x384711cc",
...
export type CollateralOverwrittenEventArgs = EParams<
  typeof events.CollateralOverwritten
>;
...
export type ExtraAssetRemovedEventArgs = EParams<
  typeof events.ExtraAssetRemoved
>;
export type InitializedEventArgs = EParams<typeof events.Initialized>;
export type OwnershipTransferStartedEventArgs = EParams<
  typeof events.OwnershipTransferStarted
>;
...
/// Function types
export type FEE_DISCOUNT_BPParams = FunctionArguments<
  typeof functions.FEE_DISCOUNT_BP
>;
export type FEE_DISCOUNT_BPReturn = FunctionReturn<
  typeof functions.FEE_DISCOUNT_BP
>;

export type SUNSET_DURATIONParams = FunctionArguments<
  typeof functions.SUNSET_DURATION
>;
export type SUNSET_DURATIONReturn = FunctionReturn<
  typeof functions.SUNSET_DURATION
>;

export type AcceptOwnershipParams = FunctionArguments<
  typeof functions.acceptOwnership
>;
export type AcceptOwnershipReturn = FunctionReturn<
  typeof functions.acceptOwnership
>;

export type AddNewExtraAssetParams = FunctionArguments<
  typeof functions.addNewExtraAsset
>;
export type AddNewExtraAssetReturn = FunctionReturn<
  typeof functions.addNewExtraAsset
>;
...
export type ConvertToAssetsParams = FunctionArguments<
  typeof functions.convertToAssets
>;
export type ConvertToAssetsReturn = FunctionReturn<
  typeof functions.convertToAssets
>;

export type ConvertToSharesParams = FunctionArguments<
  typeof functions.convertToShares
>;
export type ConvertToSharesReturn = FunctionReturn<
  typeof functions.convertToShares
>;
...
export type EnableCollateralParams = FunctionArguments<
  typeof functions.enableCollateral
>;
export type EnableCollateralReturn = FunctionReturn<
  typeof functions.enableCollateral
>;
...
export type GetCollateralTokenAtParams = FunctionArguments<
  typeof functions.getCollateralTokenAt
>;
export type GetCollateralTokenAtReturn = FunctionReturn<
  typeof functions.getCollateralTokenAt
>;

export type GetCollateralTokensParams = FunctionArguments<
  typeof functions.getCollateralTokens
>;
export type GetCollateralTokensReturn = FunctionReturn<
  typeof functions.getCollateralTokens
>;

export type GetLockedEmissionsParams = FunctionArguments<
  typeof functions.getLockedEmissions
>;
export type GetLockedEmissionsReturn = FunctionReturn<
  typeof functions.getLockedEmissions
>;
...
export type GetTotalDebtTokenDepositsParams = FunctionArguments<
  typeof functions.getTotalDebtTokenDeposits
>;
export type GetTotalDebtTokenDepositsReturn = FunctionReturn<
  typeof functions.getTotalDebtTokenDeposits
>;
...
export type LinearVestingExtraAssetsParams = FunctionArguments<
  typeof functions.linearVestingExtraAssets
>;
export type LinearVestingExtraAssetsReturn = FunctionReturn<
  typeof functions.linearVestingExtraAssets
>;
...
export type PendingOwnerParams = FunctionArguments<
  typeof functions.pendingOwner
>;
export type PendingOwnerReturn = FunctionReturn<typeof functions.pendingOwner>;

export type PreviewDepositParams = FunctionArguments<
  typeof functions.previewDeposit
>;
export type PreviewDepositReturn = FunctionReturn<
  typeof functions.previewDeposit
>;
...
export type PreviewRedeemParams = FunctionArguments<
  typeof functions.previewRedeem
>;
export type PreviewRedeemReturn = FunctionReturn<
  typeof functions.previewRedeem
>;

export type PreviewWithdrawParams = FunctionArguments<
  typeof functions.previewWithdraw
>;
export type PreviewWithdrawReturn = FunctionReturn<
  typeof functions.previewWithdraw
>;
...
export type ReceiveDonationsParams = FunctionArguments<
  typeof functions.receiveDonations
>;
export type ReceiveDonationsReturn = FunctionReturn<
  typeof functions.receiveDonations
>;
...
export type RemoveExtraAssetParams = FunctionArguments<
  typeof functions.removeExtraAsset
>;
export type RemoveExtraAssetReturn = FunctionReturn<
  typeof functions.removeExtraAsset
>;
...
export type SetPairThresholdParams = FunctionArguments<
  typeof functions.setPairThreshold
>;
export type SetPairThresholdReturn = FunctionReturn<
  typeof functions.setPairThreshold
>;

export type SetRebalancerParams = FunctionArguments<
  typeof functions.setRebalancer
>;
export type SetRebalancerReturn = FunctionReturn<
  typeof functions.setRebalancer
>;

export type SetUnlockRatePerSecondParams = FunctionArguments<
  typeof functions.setUnlockRatePerSecond
>;
export type SetUnlockRatePerSecondReturn = FunctionReturn<
  typeof functions.setUnlockRatePerSecond
>;

export type StartCollateralSunsetParams = FunctionArguments<
  typeof functions.startCollateralSunset
>;
export type StartCollateralSunsetReturn = FunctionReturn<
  typeof functions.startCollateralSunset
>;
...
export type TotalAssetsUnlockedParams = FunctionArguments<
  typeof functions.totalAssetsUnlocked
>;
export type TotalAssetsUnlockedReturn = FunctionReturn<
  typeof functions.totalAssetsUnlocked
>;
...
export type UnclaimedUnvestedAmountParams = FunctionArguments<
  typeof functions.unclaimedUnvestedAmount
>;
export type UnclaimedUnvestedAmountReturn = FunctionReturn<
  typeof functions.unclaimedUnvestedAmount
>;

export type VestedAmountParams = FunctionArguments<
  typeof functions.vestedAmount
>;
